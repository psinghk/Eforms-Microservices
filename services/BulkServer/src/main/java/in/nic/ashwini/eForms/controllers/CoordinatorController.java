...
public class CoordinatorController {
	...
	@Autowired
	public CoordinatorController(BulkEmailService bulkEmailService, ResponseBean responseBean, Util utilityService) {
		super();
	...
	public ResponseBean approve(@RequestParam @NotEmpty String regNumber, @RequestParam("clientIp") @NotEmpty String ip,
		...
		if (bulkEmailBase.getEmployment().equalsIgnoreCase("State") && bulkEmailBase.getState().equalsIgnoreCase("punjab")
				&& bulkEmailBase.getPostingState().equalsIgnoreCase("punjab")) {
