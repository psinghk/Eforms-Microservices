 ...
 * "inetOrgPerson", "userpresenceprofile", "sunucpreferences",
 * "iplanet-am-user-service", "iplanet-am-managed-person", "icscalendaruser",
 * "inetadmin", "sunimuser", "nicemailuser", "sunamauthaccountlockout",
 * "inetuser", "inetlocalmailrecipient", "sunpresenceuser",
...
public final class UserForCreate {
	...
	////@Attribute(name = "uid")//final_sms_uid
	 ...
	 * //@Id private Name dn;
	 * 
	 * public String getDn() { return String.valueOf(this.dn); }
	 */
