...
public class AdminController {
	...
	@Autowired
	public AdminController(BulkEmailService bulkEmailService, ResponseBean responseBean, Util utilityService,AdminService adminService) {
		super();
	...
	public ResponseBean approve(@Valid @RequestBody AdminBean adminBean,@RequestParam @NotEmpty String regNumber, @RequestParam("clientIp") @NotEmpty String ip,
		...
		if (mobileAndName != null) {
			...
			/*
			 * bulkUsers = initializeBulkUserTable(ip, email, formType, remarks,
			 * mobileAndName.getMobile(), mobileAndName.getName(), regNumber);
			 */
		} else {
	...
	public Map<String, Object> validateRequest(@Valid @RequestBody AdminBean adminBean,@RequestParam @NotEmpty String regNumber, @RequestParam("clientIp") @NotEmpty String ip,
		...
		List<BulkUsers> bulkUsers=bulkEmailService.fetchBulkUserTrack(regNumber);
