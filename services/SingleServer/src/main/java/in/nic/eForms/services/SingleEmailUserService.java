...
//sunny
		...
		String org = previewFormBean.getOrganizationCategory();
		String min = previewFormBean.getMinistryOrganization();
		String dep = previewFormBean.getDepartmentDivisionDomain();
		String reqUserType = previewFormBean.getReqUserType();
		...
		//Set<String> finaldomain = getDomain(empType, email, org, min, dep, reqUserType);
		Set<String> finaldomain = getDomain(empType, email);
		String ldappreferredEmail1 = allLdapValues(preferredEmail1, idType, email);
		...
		System.out.println("fetchByEmploymentCategory:" + data);
...
//				log.debug("EmploymentCategory ", "--");
//				map.put("EmploymentCategoryError", "Selected EmploymentCategory");
//			}
