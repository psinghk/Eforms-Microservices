...
@Slf4j
public class ConditionalDesignationValidator implements ConstraintValidator<ConditionalDesignation, Object> {
    ...
    @Override
    public void initialize(ConditionalDesignation requiredIfChecked) {
