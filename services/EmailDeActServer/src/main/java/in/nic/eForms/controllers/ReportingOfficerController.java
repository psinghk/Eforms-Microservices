...
import in.nic.eForms.services.EmailDeActROService;
...
public class ReportingOfficerController {
	private final EmailDeActROService emailDeActROService;
	private final ResponseBean responseBean;
	private final Util utilityService;

	@Autowired
	public ReportingOfficerController(EmailDeActROService emailDeActROService, ResponseBean responseBean, Util utilityService) {
		super();
		this.emailDeActROService = emailDeActROService;
	...
	public ResponseBean approve(@RequestParam @NotEmpty String regNumber, @RequestParam("clientIp") @NotEmpty String ip,
		...
		return emailDeActROService.approveRO(regNumber, ip, email, remarks, submissionType,responseBean);
	}
	...
	public ResponseBean reject(@RequestParam @NotEmpty String regNumber, @RequestParam("clientIp") @NotEmpty String ip,
		...
		return emailDeActROService.rejectRO(regNumber, ip, email, remarks,responseBean);
	}
	...
	public ResponseBean manualupload(@ModelAttribute("manualUploadBean") ManualUploadBean manualUploadBean,HttpServletRequest request) throws IOException {
		...
		return emailDeActROService.manualupload(manualUploadBean, request, responseBean);
	}
