...
@Slf4j
@Service
public class EmailDeActSupportService {
	...
	@Autowired
	public EmailDeActSupportService( EmailDeActBaseRepo emailDeActBaseRepo,
			EmailDeActEmpCoordRepo emailDeActEmpCoordRepo,Util utilityService) {
		super();
		this.emailDeActBaseRepo = emailDeActBaseRepo;
		this.utilityService = utilityService;
		this.emailDeActEmpCoordRepo = emailDeActEmpCoordRepo;
	...
	public ResponseBean forwardToCoordinator(String regNumber, String ip, String email,String remarks, String coordEmail,ResponseBean responseBean) {
		...
		log.info("Email DeActivation Form forwardToCoordinator by {}",email);
		...
		if (mobileAndName != null) {
			...
			finalAuditTrack = utilityService.initializeFinalAuditTrackTable(ip, email, formType, remarks, "","support", "iNOC Support",
					regNumber);
		}
	...
	public ResponseBean forwardToDa( String regNumber,
			 String ip, String email,
			 String remarks,
			 String daEmail,ResponseBean responseBean) {
		responseBean.setRequestType("Support is forwarding the request to DA");
		log.info("Email DeActivation Form forwardToDa by {}",email);
		String formType = "emaildeactivate";
		Status status = null;
		FinalAuditTrack finalAuditTrack = null;
		MobileAndName mobileAndName = null;
	...
	public ResponseBean forwardToAdmin( String regNumber,
			 String ip, String email,
			String remarks,ResponseBean responseBean ) {
		responseBean.setRequestType("Support is forwarding the request to Admin");
		log.info("Email DeActivation Form forwardToAdmin by {}",email);
		String formType = "emaildeactivate";
		Status status = null;
		FinalAuditTrack finalAuditTrack = null;
		MobileAndName mobileAndName = null;
	...
	public ResponseBean pull(String regNumber,  String ip,
			 String email,ResponseBean responseBean) {
		responseBean.setRequestType("Support is pulling the request to itself");
		log.info("Email DeActivation Form pull by {}",email);
		String formType = "emaildeactivate";
		Status status = null;
		FinalAuditTrack finalAuditTrack = null;
		MobileAndName mobileAndName = null;
