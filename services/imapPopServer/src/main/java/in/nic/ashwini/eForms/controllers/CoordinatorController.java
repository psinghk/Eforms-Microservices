...
public class CoordinatorController {
	...
	@Autowired
	public CoordinatorController(ImapPopService imappopService, ResponseBean responseBean, Util utilityService) {
		super();
	...
	public ResponseBean approve(@RequestParam @NotEmpty String regNumber, @RequestParam("clientIp") @NotEmpty String ip,
		...
		if (imapPopBase.getEmployment().equalsIgnoreCase("State") && imapPopBase.getState().equalsIgnoreCase("punjab")
