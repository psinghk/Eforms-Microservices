...
@Slf4j
@Service
public class EmailActSupportService {
	...
	@Autowired
	public EmailActSupportService( EmailActBaseRepo emailActBaseRepo,
			EmailActEmpCoordRepo emailActEmpCoordRepo,Util utilityService) {
		super();
		this.emailActBaseRepo = emailActBaseRepo;
		this.utilityService = utilityService;
		this.emailActEmpCoordRepo = emailActEmpCoordRepo;
	...
	public ResponseBean forwardToCoordinator(String regNumber, String ip, String email,String remarks, String coordEmail,ResponseBean responseBean) {
		...
		log.info("Email Activation Form forwardToCoordinator by {}",email);
	...
	public ResponseBean forwardToDa( String regNumber,
		...
		log.info("Email Activation Form forwardToDa by {}",email);
		String formType = "emailactivate";
		Status status = null;
		FinalAuditTrack finalAuditTrack = null;
		MobileAndName mobileAndName = null;
	...
	public ResponseBean forwardToAdmin( String regNumber,
		...
		log.info("Email Activation Form forwardToAdmin by {}",email);
		String formType = "emailactivate";
		Status status = null;
		FinalAuditTrack finalAuditTrack = null;
		MobileAndName mobileAndName = null;
	...
	public ResponseBean pull(String regNumber,  String ip,
		...
		log.info("Email Activation Form pull by {}",email);
		String formType = "emailactivate";
		Status status = null;
		FinalAuditTrack finalAuditTrack = null;
		MobileAndName mobileAndName = null;
