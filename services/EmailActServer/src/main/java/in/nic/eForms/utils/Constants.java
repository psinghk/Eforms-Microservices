...
public class Constants {
	...
	public static final String EMAILACT_REGISTRATION_NO_FORMAT = "emailact-form";
	public static final String EMAILDEACT_REGISTRATION_NO_FORMAT = "emaildeact-form";
    ...
    public static final String COORDINATOR_EMAIL = "tiwari.ashwini@nic.in";
  ...
  //public static final String NIC_FIRST_COORD = "rsm@nic.in,prakash@nic.in,bkd@nic.in"; // to be uncommented in production
    ...
    public static final String SUPPORT_EMAIL = "support@gov.in";
    public static final String MAILADMIN_EMAIL = "support@gov.in";
    public static final String ERROR_MESSAGE="Something went wrong. Please try again after sometime.";
    public static final String LOCAL_FILE_LOCATION = "F://pdfSaveFiles/";
