...
public class Constants {
  ...
  //public static final String NIC_FIRST_COORD = "rsm@nic.in,prakash@nic.in,bkd@nic.in"; // to be uncommented in production
    ...
    //public static final String RAJESH_SINGH_EMAIL = "rajesh.singh@nic.in";
    public static final String RAJESH_SINGH_EMAIL = "preeti.nhq@nic.in";
    //storing file in local system 
    public static final String LOCAL_FILE_LOCATION = "/home/preeti/Desktop/SunnyVerma/";
