...
@Slf4j
public class ConditionalMobileValidator implements ConstraintValidator<ConditionalMobile, Object> {
    ...
    @Override
    public void initialize(ConditionalMobile requiredIfChecked) {
