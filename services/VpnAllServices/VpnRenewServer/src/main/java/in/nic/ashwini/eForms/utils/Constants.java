...
public class Constants {
    ...
    public static final String VPN_MAILADMIN = "preeti.nhq@nic.in,rahejapreeti@hotmail.com,rahejapreeti@gmail.com"; 
    public static final String HIMACHAL_DA_ADMIN = "kaushal.shailender@nic.in";
    public static final String VPN_MAILADMIN_EMAIL = "vpnsupport@nic.in";
    public static final String VPN_COORD_EMAIL = "vaij.v@nic.in";
    public static final String VPN_SUPPORT_EMAIL = "vpnsupport@nic.in";
    public static final String ERROR_MESSAGE="Something went wrong. Please try again after sometime.";
	public static final String MAILADMIN_EMAIL = null;
