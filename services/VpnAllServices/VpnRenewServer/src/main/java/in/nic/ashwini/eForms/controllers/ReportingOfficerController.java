...
public class ReportingOfficerController {
	...
	public ResponseBean approve(@RequestParam("regNumber") @NotEmpty String regNumber,
		...
		String formType = Constants.VPN_RENEW_FORM_KEYWORD;
		System.out.println("inside of ro :::" + formType);
		Status status = null;
		FinalAuditTrack finalAuditTrack = null;
		System.out.println("hello mohit" + vpnService.preview(regNumber));
		...
		if (vpnBase.getEmployment().equalsIgnoreCase("Others")
			...
			// checking user is nic emp or not
