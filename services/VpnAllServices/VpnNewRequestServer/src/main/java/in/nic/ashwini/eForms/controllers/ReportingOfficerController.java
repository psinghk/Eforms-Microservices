...
public class ReportingOfficerController {
	...
	public ResponseBean approve(@RequestParam("regNumber") @NotEmpty String regNumber,
		...
		String nextStatus = "";
		status = utilityService.initializeStatusTable(ip, email, formType, remarks, vpnBase.getHodMobile(),
				vpnBase.getHodName(), "ro");
		finalAuditTrack = utilityService.initializeFinalAuditTrackTable(ip, email, formType, remarks,
				vpnBase.getHodMobile(), vpnBase.getHodName(), "ro", regNumber);
