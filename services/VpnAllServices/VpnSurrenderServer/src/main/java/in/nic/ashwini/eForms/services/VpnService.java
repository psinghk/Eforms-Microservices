...
public class VpnService {
	...
	public VpnBase insert(VpnBase vpnBase) {
		if (vpnBase != null) {
			...
			String newRegNumber = "VPNSURRENDER-FORM" + currentDate;
			if (oldRegNumber == null || oldRegNumber.isEmpty()) {
				newRegNumber += "0001";
			} else {
				int newRegistrationNo = Integer.parseInt(oldRegNumber.substring(25, oldRegNumber.length())) + 1;
			...
			vpnBase.setRenewFlag("1");
			vpnBase.setSupportActionTaken("p");
			vpnBase.setUserType("vpn_surrender");
