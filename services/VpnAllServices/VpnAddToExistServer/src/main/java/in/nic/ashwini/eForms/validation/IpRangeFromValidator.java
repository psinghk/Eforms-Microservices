...
public class IpRangeFromValidator implements ConstraintValidator<IpRangeFrom, FormData> {

	String ip = "", iptype = "", ipRangFrom = "";

	@Override
	public boolean isValid(FormData formData, ConstraintValidatorContext context) {
	
		String	iptype = formData.getIptype();
		String	ip = formData.getIpRangeFrom();
