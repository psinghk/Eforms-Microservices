...
public class SupportController {
	...
	@Autowired
	public SupportController(SmsService smsService, ResponseBean responseBean, Util utilityService) {
		super();
	...
	public ResponseBean forwardToCoordinator(@RequestParam @NotEmpty String regNumber,
		...
		log.info("sms Form forwardToCoordinator by support {}",email);
		String formType = "sms";
		Status status = null;
		...
		if (mobileAndName != null) {
			...
			status = utilityService.initializeStatusTable(ip, email, formType, remarks, "", "", "iNOC Support");
	...
	public ResponseBean reject(@RequestParam @NotEmpty String regNumber, @RequestParam("clientIp") @NotEmpty String ip,
		...
		log.info("sms Form reject by support {}",email);
		String formType = "sms";
		Status status = null;
		FinalAuditTrack finalAuditTrack = null;
	...
	public ResponseBean forwardToAdmin(@RequestParam @NotEmpty String regNumber,
		...
		System.out.println("Inside support: "+regNumber);
		responseBean.setRequestType("Support is forwarding the request to Admin");
		log.info("sms Form forwardToAdmin by support {}",email);
		String formType = "sms";
		Status status = null;
		FinalAuditTrack finalAuditTrack = null;
		MobileAndName mobileAndName = null;
	...
	public ResponseBean pull(@RequestParam @NotEmpty String regNumber, @RequestParam("clientIp") @NotEmpty String ip,
		...
		log.info("sms Form pull by support {}",email);
		String formType = "sms";
		Status status = null;
		FinalAuditTrack finalAuditTrack = null;
		MobileAndName mobileAndName = null;
