...
public class AdminDashboardController {
	...
	@Autowired
	public AdminDashboardController(FinalAuditTrackRepository finalAuditTrackRepository, UtilityService utilityService, DashBoardService dashBoardService) {
		super();
	...
	public Page<FinalAuditTrack> completed(@RequestParam("email") @NotEmpty String email,@RequestParam("allowedForms") List<String> allowedForms, Pageable pageable, SearchBean searchBean) {
		Pageable sortedByIdDesc = PageRequest.of(pageable.getPageNumber(), pageable.getPageSize(),
				Sort.by("toDatetime").descending());
	...
	public Page<FinalAuditTrack> rejected(@RequestParam("email") @NotEmpty String email, @RequestParam("allowedForms") List<String> allowedForms,Pageable pageable, SearchBean searchBean) {
		Pageable sortedByIdDesc = PageRequest.of(pageable.getPageNumber(), pageable.getPageSize(),
				Sort.by("toDatetime").descending());
	...
	public Page<FinalAuditTrack> forwarded(@RequestParam("email") @NotEmpty String email, @RequestParam("allowedForms") List<String> allowedForms, Pageable pageable, SearchBean searchBean) {
		Pageable sortedByIdDesc = PageRequest.of(pageable.getPageNumber(), pageable.getPageSize(),
				Sort.by("toDatetime").descending());
		List<String> status_list = Arrays.asList("completed");
		if (searchBean.getSearchKey() != null && !searchBean.getSearchKey().isEmpty()) {
	...
	@PostMapping("all")
	public Page<FinalAuditTrack> all(@RequestParam("email") @NotEmpty String email, @RequestParam("allowedForms") List<String> allowedForms,Pageable pageable, SearchBean searchBean) {
		Pageable sortedByIdDesc = PageRequest.of(pageable.getPageNumber(), pageable.getPageSize(),
				Sort.by("toDatetime").descending());
		if (searchBean.getSearchKey() != null && !searchBean.getSearchKey().isEmpty()) {
			String searchKey = searchBean.getSearchKey();
