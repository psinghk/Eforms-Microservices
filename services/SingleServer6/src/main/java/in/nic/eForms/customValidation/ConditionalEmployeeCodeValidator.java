...
@Slf4j
public class ConditionalEmployeeCodeValidator implements ConstraintValidator<ConditionalEmployeeCode, Object> {
    ...
    @Override
    public void initialize(ConditionalEmployeeCode requiredIfChecked) {
        ...
        try {
            ...
            if (Arrays.asList(values).contains(actualValue)) {
                for (String propName : required) {
                    ...
                    valid = !requiredValue.isEmpty() && requiredValue != null;
