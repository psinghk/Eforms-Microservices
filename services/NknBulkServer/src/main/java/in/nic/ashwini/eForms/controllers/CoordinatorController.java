...
public class CoordinatorController {
	...
	@Autowired
	public CoordinatorController(NknBulkEmailService nknBulkEmailService, ResponseBean responseBean, Util utilityService) {
		super();
	...
	public ResponseBean approve(@RequestParam @NotEmpty String regNumber, @RequestParam("clientIp") @NotEmpty String ip,
		...
		if (nknBulkEmailBase.getEmployment().equalsIgnoreCase("State") && nknBulkEmailBase.getState().equalsIgnoreCase("punjab")
				&& nknBulkEmailBase.getPostingState().equalsIgnoreCase("punjab")) {
	...
	public ResponseBean reject(@RequestParam @NotEmpty String regNumber, @RequestParam("clientIp") @NotEmpty String ip,
		...
		FinalAuditTrack finalAuditTrack = null;
		MobileAndName mobileAndName = utilityService.fetchMobileAndNameFromLdap(email);
		status = initializeStatusTable(ip, email, formType, remarks, mobileAndName.getMobile(), mobileAndName.getName());
