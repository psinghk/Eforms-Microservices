...
import in.nic.ashwini.eForms.security.userdetailservice.JpaUserDetailsService;
...
//	}
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().mvcMatchers("/**").access("hasIpAddress('::1') or hasIpAddress('127.0.0.1')")
