...
@Repository
public interface RelayIPFinalAuditTrackRepo extends CrudRepository<RelayIPFinalAuditTrackDTO, Integer>{
	
	RelayIPFinalAuditTrackDTO findByRegistrationno(String regNo);
