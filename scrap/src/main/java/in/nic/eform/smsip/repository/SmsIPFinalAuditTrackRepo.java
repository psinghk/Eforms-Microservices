...
@Repository
public interface SmsIPFinalAuditTrackRepo extends CrudRepository<SmsIPFinalAuditTrackDTO, Integer>{
	
	SmsIPFinalAuditTrackDTO findByRegistrationno(String regNo);
