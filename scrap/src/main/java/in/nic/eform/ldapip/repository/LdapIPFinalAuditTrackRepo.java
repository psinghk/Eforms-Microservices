...
@Repository
public interface LdapIPFinalAuditTrackRepo extends CrudRepository<LdapIPFinalAuditTrackDTO, Integer>{
	LdapIPFinalAuditTrackDTO findByRegistrationno(String regNo);
